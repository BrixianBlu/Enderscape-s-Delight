    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
        return new RecipeProvider(registries, output) {
            ...
            public void buildRecipes() {
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightBlocks.STUFFED_FLANGER_BERRY_BLOCK, 1, 200, 20, EnderscapeBlocks.RIPE_PURUBERRY_BLOCK)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.DRIFT_GELATIN, 1, 200, 10, Items.BOWL)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.HATRED_SOUP, 1, 200, 1, Items.BOWL)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.MURUBLIGHT_SOUP, 1, 200, 5, Items.BOWL)
                        .addIngredient(EnderscapeItems.MURUBLIGHT_BRACKET_ITEM)
                        .addIngredient(EnderscapeItems.MURUBLIGHT_BRACKET_ITEM)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.RUBBLEMITE_ESCARGOT, 1, 200, 10, Items.BOWL)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.RUSTLE_SOUP, 1, 200, 10, Items.BOWL)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.SUBMERGED_TENTACLES, 1, 200, 10, Items.BOWL)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.DRIFTER_TENTACLE_SPAGHETTI, 1, 200, 10, Items.BOWL)
                        .addIngredient(ModItems.TOMATO.get())
                        .addIngredient(EnderscapeDelightItems.DRIFTER_TENTACLES)
                        .addIngredient(EnderscapeItems.MURUBLIGHT_BRACKET_ITEM)
                        .setRecipeBookCategory(CookingPotBookCategory.MEALS)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.ENLIGHTENED_PUNCH, 1, 200, 10, Items.GLASS_BOTTLE)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.BLINKING_PUNCH, 1, 200, 10, Items.GLASS_BOTTLE)
                        .addIngredient(Items.SUGAR)
                ...
                CookingPotRecipeBuilder.cookingPotRecipe(BuiltInRegistries.ITEM, EnderscapeDelightItems.DRIFT_GUMMY, 2, 100, 5)
                        .addIngredient(Items.SUGAR)
                        .addIngredient(Items.SUGAR)
                        .addIngredient(EnderscapeItems.DRIFT_JELLY_BOTTLE)
                        .unlockedByAnyIngredient(EnderscapeItems.DRIFT_JELLY_BOTTLE)
              ...
              stairBuilder(EnderscapeDelightBlocks.RUBBLE_CHITIN_STAIRS, Ingredient.of(EnderscapeDelightBlocks.RUBBLE_CHITIN_BLOCK))
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, EnderscapeDelightBlocks.RUBBLE_LANTERN)
                        ...
                        .save(output);
                shapeless(RecipeCategory.FOOD, EnderscapeItems.CHORUS_CAKE_ROLL_ITEM)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .requires(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE)
                        .unlockedBy(getHasName(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE), has(EnderscapeDelightItems.CHORUS_CAKE_ROLL_SLICE))
                        .group("chorus_cake_roll")
                        .save(output);
                shaped(RecipeCategory.FOOD, EnderscapeDelightItems.ENDER_ESCAPE)
                        .pattern("RCD")
                        .pattern(" B ")
                        .define('B', Items.BOWL)
                        .define('R', EnderscapeDelightItems.COOKED_RUSTLE_SLICE)
                        .define('C', Items.CHORUS_FRUIT)
                        .define('D', EnderscapeDelightItems.DRIFTER_TENTACLES)
                        .unlockedBy(getHasName(EnderscapeDelightItems.DRIFTER_TENTACLES), has(EnderscapeDelightItems.DRIFTER_TENTACLES))
                        .group("ender_escape")
                        .save(output);
            }
